...
FirstNames    = './dep/Names/FirstNames.txt'
MiddleNames   = './dep/Names/MiddleNames.txt'
LastNames     = './dep/Names/LastNames.txt'
CountyNames   = './dep/Names/CountyNames.txt'
PlaceNames    = './dep/Names/PlaceNames.txt'
StateNames    = './dep/Names/StateNames.txt'
CountryNames  = './dep/Names/CountryNames.txt'
CompanyNames  = './dep/Names/CompanyNames.txt'
